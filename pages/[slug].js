...
import { fullInit, state as webchatState } from '../lib/botpress-webchat';
...
export default function ShareableChatbot() {
    ...
    // Full Botpress initialization via shared module
    async function initializeBotpressShared(botTheme, domain, kbFileId, website, sessionID) {
        if (typeof window === 'undefined') return;
        if (webchatState.shareChatReady) {
        ...
        await fullInit({
            domain, kbFileId, website, sessionID,
            theme: botTheme,
            retryOpen: false,
            markShareReady: true,
        });
